<template>
  <div class="mx-auto max-w-[85rem] md:p-4 mt-20">
      ...
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pb-10">
        <div class="flex justify-center">
          <a
            ...
            href="#templates"
            ><span class="font-bold text-pink-600">PRO</span> templates
            available
            <span
        ...
        <div class="mt-5 max-w-3xl text-center mx-auto">
          <p class="text-lg text-gray-600 dark:text-gray-400">
            Bloggrify is a <strong>static</strong> blog generator built on top
            of Nuxt.js and Nuxt-content providing everything you need to start
            writing your blog hassle-free AND <strong>for free</strong>.
          </p>
        </div>
        <div class="mt-8 gap-2 flex justify-center">
          ...
          >
            Demo
            <span class="flex justify-center items-center size-7"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
